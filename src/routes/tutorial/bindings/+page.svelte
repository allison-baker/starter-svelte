...
<label class="block m-2">
	<input class="text-surface-800 my-2 p-2 rounded-md bg-tertiary-200" type="number" bind:value={a} min="0" max="10" />
	<input class="text-surface-800 my-2" type="range" bind:value={a} min="0" max="10" />
</label>

<label class="block m-2">
	<input class="text-surface-800 my-2 p-2 rounded-md bg-tertiary-200" type="number" bind:value={b} min="0" max="10" />
	<input class="text-surface-800 my-2" type="range" bind:value={b} min="0" max="10" />
</label>

<p class="m-2">{a} + {b} = {a + b}</p>

<p class="m-2 text-sm font-bold">This section demonstrates binding input types number and range to variables.</p>
