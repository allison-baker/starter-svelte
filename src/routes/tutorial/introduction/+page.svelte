...
<h1 class="text-2xl m-2 text-secondary-600 dark:text-secondary-300 font-bold">
	Welcome to my {name.toUpperCase()} Introduction page!
</h1>

<img {src} alt="animated {gifName}.gif" class="m-2 rounded" />

<p class="m-2">I put this cat gif in here by assigning some attributes in the image tag to variables in my script tag!</p>

<p class="text-sm font-bold m-2">
